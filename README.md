...
| **Agents are first-class** | Rows show the current terminal task and tab label when Herdr provides them; search agent name, task, status, workspace, cwd, pane/tab/terminal IDs, session ID, and your own aliases. |
