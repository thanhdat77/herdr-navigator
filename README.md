...
| **Agents are first-class** | Rows show the current terminal task, tab label, and workspace name when Herdr provides them; search agent name, task, status, workspace, cwd, pane/tab/terminal IDs, session ID, and your own aliases. Pane/tab IDs remain in Preview. |
